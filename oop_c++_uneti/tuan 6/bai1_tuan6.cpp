...
void tinhTong(PhanSo a[], int n)
{
	...
	cout << "(*) Tong cua " << n << " phan so la: " << tong << endl;
}
int main()
{
	PhanSo a, b, p;
	...
	p = a + b;
	cout << "Tong hai phan so la: " << p;
	p = a - b; cout << endl;
	cout << "Hieu hai phan so la: " << p;
	p = a * b; cout << endl;
	cout << "Tich hai phan so la: " << p;
	p = a / b; cout << endl;
	cout << "Thuong hai phan so la: " << p;
	cout << endl;
	int n;
	...
	if (count == 0)
		cout << "(!) Khong tim thay phan so vua nhap !!!" << endl;
	else
		cout << "(!) Tim thay phan so vua nhap la phan so thu " << k << " !!!" << endl;
	tinhTong(h,n);
	return 0;
}